...
void PenguinBody::Start() {
    ...
    new PenguinCannon(*go, Game::GetInstance().GetCurrentState().GetObjectPtr(&associated));
...
void PenguinBody::Update(float dt) {
    ...
    associated.box.x = clamp(newPos.x - associated.box.w / 2, (float) 0, (float) 1408);
    associated.box.y = clamp(newPos.y - associated.box.h / 2, (float) 0, (float) 1280);
